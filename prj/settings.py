...
SECRET_KEY = 'django-insecure-8s8xhvhet16k-4&18v5c^v*-s(kb%n2xx=lpp_*@gbgk&3kgx3'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'custom_filters': 'provito.templatetags.custom_filters'
            },
        },
    },
]
...
# EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend" # чтобы email приходил в консоль
...
# celery -A prj worker --loglevel=INFO --concurrency 1 -P solo  # а потом вот это

# celery -A prj beat    # запускаем сначала это
